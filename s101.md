...
<h1 class="page-title">101 General [R-11.2013]</h1>
<div id="d0e413" class="USC">
<h4 class="USC"><i>35 U.S.C. 122 
Confidential status of applications; publication of patent
applications.</i></h4>
<ul style="list-style-type: none;">
<li id="d0e418" class="nobull">(a) CONFIDENTIALITY.— Except as provided in subsection (b), applications for patents shall be kept in
...
<p id="d0e953">In handling an in-person request, ask the requester to wait while verifying their identification as in (B) above.</p>
</div>
