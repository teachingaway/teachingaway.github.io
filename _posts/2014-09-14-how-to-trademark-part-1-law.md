...
| | <span class="icon-stack"><i class="icon-circle-blank icon-stack-base"></i><i class=""><strong>R</strong></i></span>   | The ® symbol can only be used on a registered trademark. Unregistered trademarks use ™.
