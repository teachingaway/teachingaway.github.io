...
| <span class="icon-stack"><i class="icon-circle-blank icon-stack-base icon-muted"></i><i class="icon-muted">R</i></span> | ® Symbol  | The ® symbol can only be used on a registered trademark. Unregistered trademarks use ™.
