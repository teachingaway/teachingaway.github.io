...
| <i class="icon-3x">®</i> | <span class="icon-stack"><i class="icon-circle-blank icon-stack-base"></i><i class="icon"><strong>R</strong></i></span> | The ® symbol can only be used on a registered trademark. Unregistered trademarks use ™.
