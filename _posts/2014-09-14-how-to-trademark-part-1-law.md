...
| <span class="icon-stack"><i class="icon-circle-blank icon-stack-base icon-muted"></i><i class="icon-twitter icon-muted"></i></span> | ® Symbol  | The ® symbol can only be used on a registered trademark. Unregistered trademarks use ™.
