...
When does a company own the rights to its employee's code or inventions?  When can an employee spin off a side project without messy entanglements? These can be complicated questions. A written invention assignment agreement will drastically simplify the answers. But without a written contract, a mess of ambiguous state and federal default rules will apply.

### Takeaway for Founders

Have all your employees sign a contract with a IP assignment agreement. It doesn't need to be draconian, it just needs to spell out the details. Encouraging employees to work on creative side projects can be great for innovation. 

Also, review all co-founders IP agreements with previous companies. Learn from [Paul Graham's early mistakes](http://www.paulgraham.com/start.html),
...
First, double-check your employment agreement and the company's employment policies. There may be enforceable IP assignment agreements in either. If there isn't an applicable IP assignment provision, (a) you probably own the _patents_ to your inventions, and (b) if the project is unrelated to your employer's business, you probably also own the _copyright_ to your side-projects code.
...
> _The law on patent ownership is unacceptably complex and creates excessive uncertainty. -Prof. Donald Chisum_.
